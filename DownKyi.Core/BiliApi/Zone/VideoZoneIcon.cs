...
public class VideoZoneIcon
{
    ...
    private readonly Dictionary<int, string> _imageKeys;
    private readonly string _defaultImageKey;
    ...
    {
        _defaultImageKey = "videoUpDrawingImage";
        _imageKeys = new Dictionary<int, string>
        {
    ...
    {
        return _imageKeys.TryGetValue(tid, out var imageKey) ? imageKey : _defaultImageKey;
    }
}
