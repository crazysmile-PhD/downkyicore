...
public sealed class CentralTestRunnerCancellationComponentTests
{
    ...
    [InlineData("Win32Exception")]
    [InlineData("InvalidOperationException")]
    public async Task IdentityObservationWaitsAfterReadFailureUntilProcessExits(string exceptionType)
    {
        Process? fixture = null;
        await FailurePreservingTestCleanup.RunAsync(
            async () =>
    ...
    [Fact]
    public async Task IdentityObservationKeepsUnknownUntilCancellation()
    {
        Process? fixture = null;
        await FailurePreservingTestCleanup.RunAsync(
            async () =>
    ...
    [Fact]
    public async Task IdentityObservationUnknownExpiresWithinOwnedWaitDeadline()
    {
        Process? fixture = null;
        await FailurePreservingTestCleanup.RunAsync(
            async () =>
