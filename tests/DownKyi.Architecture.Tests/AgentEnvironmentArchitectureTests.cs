...
public sealed class AgentEnvironmentArchitectureTests
{
    ...
    public void ContinuousIntegrationAutomaticallyValidatesChanges()
    {
        ...
        Assert.Contains("ubuntu-26.04", qualityWorkflow, StringComparison.Ordinal);
    ...
    public void ContinuousIntegrationBoundsAndRetriesOnlyAnIsolatedBuildTestTimeout()
    {
        ...
        Assert.Contains("- ubuntu-26.04", buildTest, StringComparison.Ordinal);
        ...
        Assert.Contains("Build and test (ubuntu-26.04)", retryWorkflow, StringComparison.Ordinal);
