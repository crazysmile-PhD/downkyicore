...
- Fix the remaining 486 diagnostics across 19 CA rules in separate commits ordered by public API design, then naming/globalization/style; 55 security, async, disposal, exception, lifecycle, null-contract, correctness, collection, API-shape, performance, and allocation rules are already at zero and enforced as errors.
