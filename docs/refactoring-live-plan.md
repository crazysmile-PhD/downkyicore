...
- Fix the remaining 1,062 diagnostics across 35 CA rules in separate commits ordered by public API/collection design, then naming/globalization/style; 37 security, async, disposal, exception, lifecycle, performance, and allocation rules are already at zero and enforced as errors.
