...
- Fix the remaining 491 diagnostics across 20 CA rules in separate commits ordered by public API design, then naming/globalization/style; 54 security, async, disposal, exception, lifecycle, null-contract, correctness, collection, API-shape, performance, and allocation rules are already at zero and enforced as errors.
