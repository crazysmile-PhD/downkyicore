...
- Replace ViewModel `Task.Run` calls with page-specific cancellable use cases; 26 active call sites remain, excluding comments, after video-detail, user-space, Bili Helper, index session refresh, and QR login work moved to coordinators.
