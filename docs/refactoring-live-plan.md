...
- Fix the remaining 510 diagnostics across 21 CA rules in separate commits ordered by public API design, then naming/globalization/style; 53 security, async, disposal, exception, lifecycle, null-contract, correctness, collection, API-shape, performance, and allocation rules are already at zero and enforced as errors.
