...
public class SystemIcon
{
    ...
    private SystemIcon()
    {
        ...
        Maximize = new VectorImage
        {
            ...
            Width = 12,
            Data =
                @"M31.1,33H18.9c-1,0-1.9-0.9-1.9-1.9V18.9c0-1,0.9-1.9,1.9-1.9h12.3c1,0,1.9,0.9,1.9,1.9v12.3C33,32.1,32.1,33,31.1,33z
        ...
        Minimize = new VectorImage
        {
            ...
            Width = 12,
            Data =
                "M17.8,25.8c-0.5,0-0.8-0.3-0.8-0.8s0.3-0.8,0.8-0.8h14.4c0.5,0,0.8,0.3,0.8,0.8s-0.3,0.8-0.8,0.8H17.8z",
            Fill = "#FF000000"
        };
        ...
        Restore = new VectorImage
        {
            ...
            Width = 12,
            Data =
                @"M29,33H18.3c-0.7,0-1.3-0.6-1.3-1.3V21c0-0.7,0.6-1.3,1.3-1.3H29c0.7,0,1.3,0.6,1.3,1.3v10.7C30.4,32.4,29.8,33,29,33z
        ...
        Skin = new VectorImage
        {
            ...
            Width = 12,
            Data =
                @"M29.1,18.1l2.7,3.2l-1.3,1.6c-0.1-0.1-0.3-0.1-0.5-0.1c-0.6,0-1,0.5-1,1.2v8.1h-8.2v-8.1c0-0.7-0.5-1.2-1-1.2
