...
public class NormalIcon
{
    ...
    public NormalIcon()
    {
        Play = new VectorImage
        {
            ...
            Width = 14.75,
            Data =
                @"M869.03 707.93 l-465.29 281.31 q-86.66 49.32 -178.65 28.65 q-91.99 -20.66 -146.65 -103.31 q-36 -56 -36 -121.33
        ...
        Favorite = new VectorImage
        {
            ...
            Width = 16,
            Data =
                @"M772.12 303.28 q-37.33 -5.83 -66.49 -28 q-29.16 -22.16 -44.32 -55.99 l-83.99 -176.13 q-22.16 -43.16 -65.91 -43.16
        ...
        Share = new VectorImage
        {
            ...
            Width = 16,
            Data =
                @"M453.23 283.64 l0 -219.44 q1.16 -26.85 18.67 -45.53 q17.51 -18.68 44.36 -18.68 q23.34 0 40.85 15.17 l441.21 375.85
        ...
        CloudDownload = new VectorImage
        {
            ...
            Width = 48,
            Data =
                @"M19.4,10c-0.7-3.4-3.7-6-7.4-6C9.1,4,6.6,5.6,5.3,8C2.3,8.4,0,10.9,0,14c0,3.3,2.7,6,6,6h13c2.8,0,5-2.2,5-5
        ...
        Downloading = new VectorImage
        {
            ...
            Width = 16,
            Data =
                @"M1,11.7c0.6,0,1,0.5,1,1V24H1.4C0.6,24,0,23.4,0,22.6c0,0,0,0,0,0v-9.9C0,12.1,0.5,11.7,1,11.7C1,11.7,1,11.7,1,11.7z
        ...
        DownloadFinished = new VectorImage
        {
            ...
            Width = 16,
            Data =
                @"M12,0C8.6,0.1,5.8,1.3,3.5,3.5S0.1,8.6,0,12c0.1,3.4,1.3,6.2,3.5,8.5S8.6,23.9,12,24c3.4-0.1,6.2-1.3,8.5-3.5
        ...
        CoinIcon = new VectorImage
        {
            ...
            Width = 20,
            Data =
                @"M473.7 358.8 l0 -54.42 l-129.01 0 q-16.12 0 -27.21 -11.09 q-11.09 -11.09 -11.09 -27.72 q0 -16.63 11.09 -27.21
        ...
        MoneyIcon = new VectorImage
        {
            ...
            Width = 20,
            Data =
                @"M409.2 444.47 l138.08 0 q28.22 -1.01 46.36 -19.15 q18.14 -18.14 18.14 -45.85 q0 -27.72 -18.14 -46.36
        ...
        BindingEmail = new VectorImage
        {
            ...
            Width = 20,
            Data =
                @"M512 1024 q-218 -5 -362.5 -149.5 q-144.5 -144.5 -149.5 -362.5 q5 -218 149.5 -362.5 q144.5 -144.5 362.5 -149.5
        ...
        FavoriteOutline = new VectorImage
        {
            ...
            Width = 24,
            Data =
                @"M755.8 1021.89 q-13.98 -1 -28.45 -4.5 q-14.47 -3.5 -29.45 -8.49 l-146.74 -76.87 q-18.97 -13.97 -39.93 -13.97
        ...
        Subscription = new VectorImage
        {
            ...
            Width = 24,
            Data =
                @"M512 945.07 q-6.15 0 -13.53 -2.46 q-7.39 -2.46 -13.54 -4.92 q-43.07 -32 -190.74 -153.83 q-147.67 -121.83 -211.65 -200.59
        ...
        VideoUp = new VectorImage
        {
            ...
            Width = 24,
            Data =
                @"M711,212.3l47-47c41.7-47.6-25-112.2-72-71l-107,106c-3.3,3.3-6,7-8,11H454c-1.3-2.7-3.3-5-6-7l-112-111
        ...
        Channel1 = new VectorImage
        {
            ...
            Width = 24,
            Data =
                @"M116.57 0 q-30.86 0 -57.71 16 q-26.85 16 -42.85 42.85 q-16 26.85 -16 57.71 l0 468.57 q0 30.86 16 57.72
        ...
        PlatformIpad = new VectorImage
        {
            ...
            Width = 16,
            Data =
                @"M804.57 0 q40 0 73.72 19.43 q33.71 19.43 53.14 53.15 q19.43 33.72 19.43 73.71 l0 731.42 q0 40 -19.43 73.71
        ...
        PlatformMobile = new VectorImage
        {
            ...
            Width = 16,
            Data =
                @"M694.86 0 q40 0 73.72 19.43 q33.71 19.43 53.14 53.15 q19.43 33.72 19.43 73.71 l0 731.42 q0 40 -19.43 73.71
        ...
        PlatformPC = new VectorImage
        {
            ...
            Width = 16,
            Data =
                @"M694.86 804.57 q14.85 0 25.71 10.86 q10.86 10.86 10.86 25.71 q0 14.86 -10.86 25.71 q-10.86 10.86 -25.71 10.86
        ...
        PlatformTV = new VectorImage
        {
            ...
            Width = 16,
            Data =
                @"M768 804.57 q14.86 0 25.72 10.86 q10.86 10.86 10.86 25.71 q0 14.86 -10.86 25.71 q-10.86 10.86 -25.72 10.86
